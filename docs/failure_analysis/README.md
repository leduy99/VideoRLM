...
- `qwen3_8b_vs_qwen3_5_9b_90run.md`: so sánh hai controller `Qwen3-8B` và `Qwen3.5-9B` trên cùng 90 sample, giải thích vì sao model mạnh hơn lại cho score benchmark thấp hơn trong controller setup hiện tại
